...
var entryUnbind = __w_pdfjs_require__(188);
...
var collection = __w_pdfjs_require__(192);
var collectionStrong = __w_pdfjs_require__(198);
...
var isForced = __w_pdfjs_require__(64);
var redefine = __w_pdfjs_require__(46);
var InternalMetadataModule = __w_pdfjs_require__(193);
var iterate = __w_pdfjs_require__(165);
var anInstance = __w_pdfjs_require__(97);
var isCallable = __w_pdfjs_require__(20);
var isObject = __w_pdfjs_require__(19);
...
var defineProperty = (__w_pdfjs_require__(43).f);
var getOwnPropertyNamesModule = __w_pdfjs_require__(55);
var getOwnPropertyNamesExternalModule = __w_pdfjs_require__(194);
var isExtensible = __w_pdfjs_require__(195);
var uid = __w_pdfjs_require__(39);
var FREEZING = __w_pdfjs_require__(197);
var REQUIRED = false;
...
var isObject = __w_pdfjs_require__(19);
var classof = __w_pdfjs_require__(15);
var ARRAY_BUFFER_NON_EXTENSIBLE = __w_pdfjs_require__(196);
...
var setSpecies = __w_pdfjs_require__(133);
var DESCRIPTORS = __w_pdfjs_require__(6);
var fastKey = (__w_pdfjs_require__(193).fastKey);
var InternalStateModule = __w_pdfjs_require__(48);
var setInternalState = InternalStateModule.set;
...
var lengthOfArrayLike = __w_pdfjs_require__(60);
var validateArgumentsLength = __w_pdfjs_require__(109);
var getRegExpFlags = __w_pdfjs_require__(202);
var ERROR_STACK_INSTALLABLE = __w_pdfjs_require__(179);
var Object = global.Object;
...
var _font_loader = __w_pdfjs_require__(210);

var _annotation_storage = __w_pdfjs_require__(211);

var _canvas = __w_pdfjs_require__(215);

var _worker_options = __w_pdfjs_require__(221);

var _is_node = __w_pdfjs_require__(219);

var _message_handler = __w_pdfjs_require__(222);

var _metadata = __w_pdfjs_require__(224);

var _optional_content_config = __w_pdfjs_require__(225);

var _transport_stream = __w_pdfjs_require__(226);

var _xfa_text = __w_pdfjs_require__(227);
...
var _base_factory = __w_pdfjs_require__(209);
...
var getOwnPropertyNames = (__w_pdfjs_require__(55).f);
var isPrototypeOf = __w_pdfjs_require__(23);
var isRegExp = __w_pdfjs_require__(207);
var toString = __w_pdfjs_require__(66);
var getRegExpFlags = __w_pdfjs_require__(202);
var stickyHelpers = __w_pdfjs_require__(70);
var proxyAccessor = __w_pdfjs_require__(208);
var redefine = __w_pdfjs_require__(46);
var fails = __w_pdfjs_require__(7);
var hasOwn = __w_pdfjs_require__(37);
...
var _editor = __w_pdfjs_require__(212);

var _murmurhash = __w_pdfjs_require__(214);
...
var _tools = __w_pdfjs_require__(213);
...
class CommandManager {
  ...
  add(cmd, undo) {
    ...
    const next = (_classPrivateFieldGet(this, _position) + 1) % _classPrivateFieldGet(this, _maxSize);
...
class AnnotationEditorUIManager {
  ...
  suppress(layer) {
    ...
    if (_classPrivateFieldGet(this, _isAllSelected)) {
      const editors = Array.from(_classPrivateFieldGet(this, _allEditors).values());
      ...
      const editor = _classPrivateFieldGet(this, _activeEditor);
  ...
  paste(layer) {
    const editor = _classPrivateFieldGet(this, _clipboardManager).paste();
...
var _pattern_helper = __w_pdfjs_require__(218);

var _image_utils = __w_pdfjs_require__(220);
...
var _freetext = __w_pdfjs_require__(230);

var _ink = __w_pdfjs_require__(231);
...
class AnnotationEditorLayer {
  constructor(options) {
    ...
    for (const editor of _classPrivateFieldGet(this, _uiManager).getEditors(options.pageIndex)) {
      this.add(editor);
    }
...
class FreeTextEditor extends _editor.AnnotationEditor {
  constructor(params) {
    ...
    _classPrivateFieldInitSpec(this, _contentHTML, {
      writable: true,
      value: ""
    });
    ...
    _classPrivateFieldSet(this, _color, params.color || "CanvasText");

    _classPrivateFieldSet(this, _fontSize, params.fontSize || 10);
  }
...
var _fit_curve = __w_pdfjs_require__(232);
...
class InkEditor extends _editor.AnnotationEditor {
  constructor(params) {
    ...
    _classPrivateMethodInitSpec(this, _buildPath2D);
    ...
    _classPrivateFieldInitSpec(this, _boundCanvasMousemove, {
      writable: true,
      value: void 0
    });

    _classPrivateFieldInitSpec(this, _boundCanvasMouseleave, {
      writable: true,
      value: void 0
    });

    _classPrivateFieldInitSpec(this, _boundCanvasMouseup, {
      writable: true,
      value: void 0
    });

    _classPrivateFieldInitSpec(this, _boundCanvasMousedown, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldSet(this, _baseWidth, _classPrivateFieldSet(this, _baseHeight, 0));

    _classPrivateFieldSet(this, _aspectRatio, 0);

    _classPrivateFieldSet(this, _disableEditing, false);
    ...
    _classPrivateFieldSet(this, _boundCanvasMousemove, this.canvasMousemove.bind(this));

    _classPrivateFieldSet(this, _boundCanvasMouseleave, this.canvasMouseleave.bind(this));

    _classPrivateFieldSet(this, _boundCanvasMouseup, this.canvasMouseup.bind(this));

    _classPrivateFieldSet(this, _boundCanvasMousedown, this.canvasMousedown.bind(this));
  }
...
function _stopDrawing2(x, y) {
  ...
  const path2D = _classPrivateMethodGet(this, _buildPath2D, _buildPath2D2).call(this, bezier);
...
var $ = __w_pdfjs_require__(3);
var $reduce = (__w_pdfjs_require__(234).left);
var arrayMethodIsStrict = __w_pdfjs_require__(235);
var CHROME_VERSION = __w_pdfjs_require__(26);
var IS_NODE = __w_pdfjs_require__(149);
...
var _scripting_utils = __w_pdfjs_require__(237);

var _xfa_layer = __w_pdfjs_require__(238);
...
class WidgetAnnotationElement extends AnnotationElement {
  ...
  _setTextStyle(element) {
    ...
    if (this.data.multiLine) {
      ...
      const height = Math.abs(this.data.rect[3] - this.data.rect[1]);
      style.fontSize = "".concat(Math.min(fontSize, Math.round(height / _util.LINE_FACTOR)), "px");
    }
...
var _network_utils = __w_pdfjs_require__(243);
...
var _content_disposition = __w_pdfjs_require__(244);
...
var _annotation_editor_layer = __w_pdfjs_require__(229);

var _tools = __w_pdfjs_require__(213);

var _annotation_layer = __w_pdfjs_require__(236);

var _worker_options = __w_pdfjs_require__(221);

var _is_node = __w_pdfjs_require__(219);

var _text_layer = __w_pdfjs_require__(239);

var _svg = __w_pdfjs_require__(241);
